    ...
    public class UpdateUserUseCaseTest
    {
        ...
        public async Task Error_Email_Already_Registered()
        {
            ...
            await act.Should().ThrowAsync<ErrorOnValidationException>()
                .Where(e => e.ErrorMessages.Count.Equals(1) && e.ErrorMessages.Contains(ResourceMessagesException.EMAIL_ALREADY_REGISTERED));
        ...
        {
            /* 
             * var x = new UserUpdateOnlyRepositoryBuilder();
             * var y = x.GetById(user);
             * y.Build();
             */
