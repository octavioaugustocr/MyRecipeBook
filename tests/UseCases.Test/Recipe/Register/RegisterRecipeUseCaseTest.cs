    ...
    public class RegisterRecipeUseCaseTest
    {
        ...
        public async Task Error_Title_Empty()
        {
            ...
            (await act.Should().ThrowAsync<ErrorOnValidationException>())
                .Where(e => e.ErrorMessages.Count.Equals(1) && e.ErrorMessages.Contains(ResourceMessagesException.RECIPE_TITLE_EMPTY));
        }
        ...
        public async Task Error_Invalid_File()
        {
            ...
            (await act.Should().ThrowAsync<ErrorOnValidationException>())
                .Where(e => e.ErrorMessages.Count == 1 && e.ErrorMessages.Contains(ResourceMessagesException.ONLY_IMAGES_ACCEPTED));
        }
        ...
        private static RegisterRecipeUseCase CreateUseCase(MyRecipeBook.Domain.Entities.User user)
        {
            ...
            var blobStorage = new BlobStorageServiceBuilder().GetFileUrl(user, string.Empty).Build();
